...
plt.title('Health Expenditure as a Percentage of GDP vs Air Quality Index Value', fontsize=16)
plt.xlabel('AQI Value', fontsize=12)
plt.ylabel('Health Expenditure', fontsize=12)
plt.tight_layout()
plt.savefig("./graphs/airquality_healthexp_scatter.png")

correlation_matrix = numeric_data.corr()
plt.figure(figsize=(10, 8))
sns.heatmap(correlation_matrix, annot=True, cmap='coolwarm', fmt='.2f', linewidths=0.5, cbar=True)
plt.title('Health Expenditure, Respiratory Disease Deaths, and AQI', fontsize=16)
plt.tight_layout()
plt.savefig("./graphs/airquality_deaths_healthcare_heatmap.png")