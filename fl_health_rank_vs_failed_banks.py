...
plt.plot(vCrime['Banks closed'],vCrime['Raw value'],)
plt.plot(unem['Banks closed'],unem['Raw value'])
plt.plot(unin['Banks closed'],unin['Raw value'])
plt.plot(std['Banks closed'],std['Raw value'])
plt.plot(inact['Banks closed'],inact['Raw value'])
plt.plot(obs['Banks closed'],obs['Raw value'])
plt.xlabel("Banks Closed")
plt.ylabel("Raw Value")
plt.savefig('bank-graphs/plot.png')
plt.close()

sb.heatmap(vCrime.corr(numeric_only=True), annot=True)
plt.title("Violent Crime")
plt.savefig("bank-graphs/violentCrime.png")
plt.close()

sb.heatmap(unem.corr(numeric_only=True), annot=True)
plt.title("Unemployment")
plt.savefig("bank-graphs/unemployement.png")
plt.close()

sb.heatmap(unin.corr(numeric_only=True), annot=True)
plt.title("Uninsured")
plt.savefig("bank-graphs/uninsured.png")
plt.close()

sb.heatmap(std.corr(numeric_only=True), annot=True)
plt.title("Sexually Transmitted Diseases")
plt.savefig("bank-graphs/std.png")
plt.close()

sb.heatmap(inact.corr(numeric_only=True), annot=True)
plt.title("Physical Inactivity")
plt.savefig("bank-graphs/physicalInactivity.png")
plt.close()

sb.heatmap(obs.corr(numeric_only=True), annot=True)
plt.title("Adult Obesity")
plt.savefig("bank-graphs/adultObesity.png")
plt.close()
